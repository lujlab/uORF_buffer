...
The scripts utilize [numba](https://numba.pydata.org/) to accelerate the simulation. Pleas [install it](https://numba.readthedocs.io/en/stable/user/installing.html) before using the scripts.<br/><br/>
